...
export const RegisterPage: React.FC = () => {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (fnTrimmed.length < 2 || fnTrimmed.length > 30) {
            setValidationError('First name phải từ 2-30 ký tự');
            return;
        }
        ...
        if (lnTrimmed.length < 2 || lnTrimmed.length > 30) {
            setValidationError('Last name phải từ 2-30 ký tự');
            return;
        }
